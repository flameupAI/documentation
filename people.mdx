...
<Callout kind="info">**Required Permission**: `people:read` for GET requests, `people:write` for POST/PUT requests, `people:delete` for DELETE requests.</Callout>
...
| `anonymousId` | string | Anonymous identifier for linking anonymous to known users |
...
|-----------|------|---------|-------------|
| `limit` | integer | 50 | Number of results (max 1000) |
