...
<Callout kind="warning">Device registration currently requires a **full-access** API key (`*`) — there is no grantable `devices` scope yet. Create a separate full-access key for this step, or skip ahead to Step 5.</Callout>
