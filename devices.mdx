...
<Callout kind="info">**Required Permission**: `devices:write` for all device operations.</Callout>
...
<Callout kind="tip">The `person_id` is passed in the URL path, not in the request body.</Callout>
