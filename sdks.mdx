...
// Usage
const flare = new Flameup('flare_live_xxx', 'ws_abc123');
...
const flare = axios.create({
  ...
  headers: {
    'Authorization': 'Bearer flare_live_xxx'
  }
});
...
# Usage
flare = Flameup('flare_live_xxx', 'ws_abc123')
...
async def main():
    flare = AsyncFlameup('flare_live_xxx', 'ws_abc123')
...
// Usage
let flare = Flameup(apiKey: "flare_live_xxx", workspaceId: "ws_abc123")
...
// Usage
val flare = Flameup("flare_live_xxx", "ws_abc123")
