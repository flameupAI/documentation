...
set. The request names the person by `external_id`, so a key that ships inside
your app can write any trait on any person whose identifier someone can guess or
read out of your own API responses. Nothing in the request proves the install
